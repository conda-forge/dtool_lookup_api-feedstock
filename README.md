...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtool_lookup_api-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13794&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtool_lookup_api-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtool_lookup_api` can be installed with:

```
conda install dtool_lookup_api
```

It is possible to list all of the versions of `dtool_lookup_api` available on your platform with:
